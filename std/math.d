...
version (LDC)
{
    // FIXME: core.stdc.math.ldexpl not available under Windows
    version (Windows) real ldexp(real n, int exp) @trusted pure nothrow { assert(0); }
    else              real ldexp(real n, int exp) @trusted pure nothrow { return core.stdc.math.ldexpl(n, exp); }
}
else
...
real log10(real x) @trusted pure nothrow
{
    version (LDC)
    {
      version (LDC_LLVM_303)
        ...
        assert(0); // FIXME: core.stdc.math.log10l not available under Windows
      else
...
real scalbn(real x, int n) @trusted nothrow
{
    ...
    {
      version (Windows)
        assert(0); // FIXME: core.stdc.math.scalbnl not available under Windows
      else
